...
public class Enemy extends Entity
{
    ...
    public Enemy(int x, int y, int width, int height, BufferedImage sprite)
    {
        ...
        EnemyMoveRight = new BufferedImage[5];/*Animacao para direita*/
        EnemyMoveLeft = new BufferedImage[5];/*Animacao para esquerda*/
    ...
    para prevenir deles ocuparem o mesmo espaço*/
    ...
    public void render(Graphics g)
    {
        ...
        /*Mascara de Colisao da classe Enemy*/
        if (showMask)
        {
