        ...
        try
        {
            ...
            for (int xx = 0; xx < map.getWidth(); xx++)
            {
                for (int yy = 0; yy < map.getHeight(); yy++)
                {
                    ...
                    TrashCan tc_up = new TrashCan(xx * TILE_SIZE, yy * (TILE_SIZE - 20), TILE_SIZE, TILE_SIZE, Entity.TRASH_full_EN);
                    ...
                    switch (pixelAtual)
                    {
                        ...
                        case 0xFFFFD800:
                        {
                            /* caso a variavel xx do contador seja multiplo de 5,
                            o tile sera igual a umatile variante do mesmo. */
                            if (xx % 5 == 0)
